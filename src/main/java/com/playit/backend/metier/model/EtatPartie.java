...
public enum EtatPartie {
	CREEE, ATTENTE_EQUIPE_INSCRIPTION, ATTENTE_EQUIPE_RECONNEXION, EN_PAUSE, CHOIX_PLATEAU, ATTENTE_ACTIVITE, ACTIVITE_EN_COURS, EXPLICATION, TERMINEE;

	static {
		CREEE.precedents = Arrays.asList();
		ATTENTE_EQUIPE_INSCRIPTION.precedents = Arrays.asList(CREEE);
