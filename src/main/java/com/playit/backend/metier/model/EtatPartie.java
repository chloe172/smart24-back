...
public enum EtatPartie {
	ATTENTE_EQUIPE_INSCRIPTION, ATTENTE_EQUIPE_RECONNEXION, EN_PAUSE, CHOIX_PLATEAU, ATTENTE_ACTIVITE,
	ACTIVITE_EN_COURS, EXPLICATION, TERMINEE;
	...
	static {
		...
		TERMINEE.precedents = Arrays.asList(CHOIX_PLATEAU, EXPLICATION, ATTENTE_ACTIVITE, EN_PAUSE);
	}
